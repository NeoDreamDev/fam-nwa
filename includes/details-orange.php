    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item current"><a href="shop.php">Shop</a></li>
                <li class="breadcrumb-item current" aria-current="page">Orange Deux Head Wrap</li>
            </ol>
        </nav>
    </div>
    <!-- BREADCRUMB END -->
                ...
                <div id="carouselExampleControls" class="carousel h-auto slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../img/goldScarf.png" class="d-block w-100" alt="...">
                        </div>
